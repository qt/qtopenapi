...
|*postApplicationJsonArray* | *POST* /reqBody/appjson/array/postApplicationJsonArray | Put request-body, application-json, array.|
|*postApplicationJsonBool* | *POST* /reqBody/appjson/bool/postApplicationJsonBool | Post request-body, application-json, boolean.|
|*postApplicationJsonInt* | *POST* /reqBody/appjson/integer/postApplicationJsonInt | Post request-body, application-json, integer.|
|*postApplicationJsonMap* | *POST* /reqBody/appjson/object/postApplicationJsonMap | Post request-body, application-json, map of object.|
...
int main(int argc, char *argv[]) {
    ...
    /*
        Handle the 'binaryType()' operation response directly in the callback.
    ...
    */
    apiInstance.binaryType(body, nullptr, [&](QRestReply &reply, QString summary) {
        if (reply.isSuccess())
