...
QByteArray decompress(const QByteArray &data, OAICompressionType compressionType)
{
    Q_UNUSED(data);
...
QByteArray compress(const QByteArray &input, int level, OAICompressionType compressionType)
{
    Q_UNUSED(input);
    Q_UNUSED(level);
    Q_UNUSED(compressionType);
