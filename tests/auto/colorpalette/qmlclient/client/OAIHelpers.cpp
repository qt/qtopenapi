...
bool fromByteArray(const QByteArray &input, OAIObject &value)
{
    ...
    if (err.error == QJsonParseError::NoError) {
        // TODO: rework OAIObject to take QBA?
...
{
    // TODO: rework OAIEnum to take QBA?
    value.fromJson(QString::fromUtf8(input));
    return true;
}
...
QString parameterToString(const QString &key, const QString &assignOperator, const QJsonValue &jval)
{
    ...
    switch(jval.type()) {
        case QJsonValue::String:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + QUrl::toPercentEncoding(jval.toString()));
            break;
        case QJsonValue::Double:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + QUrl::toPercentEncoding(QVariant(jval.toDouble()).toString()));
            break;
        case QJsonValue::Bool:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + QUrl::toPercentEncoding(QVariant(jval.toBool()).toString()));
            break;
        case QJsonValue::Array:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + ::OpenAPI::toStringValue(jval.toArray().toVariantList(), assignOperator));
            break;
        case QJsonValue::Object:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + ::OpenAPI::toStringValue(jval.toObject().toVariantMap(), assignOperator));
            break;
        case QJsonValue::Null: // path value cannot be null because it's always required.
            break;
