...
apps=("PetApiTest/cpp-qt-petstore-petapi"
      "StoreApiTest/cpp-qt-petstore-storeapi"
      "UserApiTest/cpp-qt-petstore-userapi")
folders=("PetApiTest" "StoreApiTest" "UserApiTest")
if [[ -z "${RUN_VALGRIND_TESTS}" ]]; then
    for i in "${folders[@]}"
    do
        echo "Running Qt Petstore Test: " $i
        cd $i
        ctest
        cd ..
    done
