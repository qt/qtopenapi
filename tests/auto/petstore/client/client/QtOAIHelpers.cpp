...
QString parameterToString(const QString &key, const QString &assignOperator, const QJsonValue &jval)
{
    ...
    switch(jval.type()) {
        ...
        case QJsonValue::Array:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + ::QtOpenAPI::toStringValue(jval.toArray().toVariantList(), assignOperator));
            break;
        case QJsonValue::Object:
            paramString.append(QUrl::toPercentEncoding(key) + assignOperator + ::QtOpenAPI::toStringValue(jval.toObject().toVariantMap(), assignOperator));
            break;
