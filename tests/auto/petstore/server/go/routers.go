...
func getRoutes(handleFunctions ApiHandleFunctions) []Route {
	return []Route{ 
		...
		{
			"FindPetsByAgeAndPatience",
			http.MethodGet,
			"/v2/pet/findPetsByAgeAndPatience/:petData",
			handleFunctions.PetAPI.FindPetsByAgeAndPatience,
		},
		{
			"FindPetsByStatus",
			http.MethodGet,
		...
		},
		{
			"FindPetsImageById",
			http.MethodGet,
			"/v2/pet/findPetsImageById",
			handleFunctions.PetAPI.FindPetsImageById,
		},
		{
			"GetJsonFile",
			http.MethodGet,
			"/v2/pet/:petId/uploadImage",
			handleFunctions.PetAPI.GetJsonFile,
		},
		{
			"GetPetById",
			http.MethodGet,
		...
		},
		{
			"CreateInQueryMap",
			http.MethodPost,
			"/v2/user/createInQueryMap",
			handleFunctions.UserAPI.CreateInQueryMap,
		},
		{
			"CreateUser",
			http.MethodPost,
