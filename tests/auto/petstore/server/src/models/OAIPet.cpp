...
void OAIPet::initializeModel() {
    ...
    m_patience_isSet = false;
    m_patience_isValid = false;
}
...
void OAIPet::fromJsonObject(QJsonObject json) {
    ...
    m_patience_isValid = ::OpenAPI::fromJsonValue(patience, json[QString("patience")]);
    m_patience_isSet = !json[QString("patience")].isNull() && m_patience_isValid;
}
...
QJsonObject OAIPet::asJsonObject() const {
    ...
    if (m_patience_isSet) {
        obj.insert(QString("patience"), ::OpenAPI::toJsonValue(patience));
    }
    return obj;
}
...
bool OAIPet::is_age_Set() const{
    return m_age_isSet;
}

bool OAIPet::is_age_Valid() const{
...
void OAIPet::setPatience(const qint32 &patience) {
    ...
    this->m_patience_isSet = true;
}

bool OAIPet::is_patience_Set() const{
    return m_patience_isSet;
}

bool OAIPet::is_patience_Valid() const{
    return m_patience_isValid;
}
