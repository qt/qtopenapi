...
class QtOAIDoubleResponse : public QtOAIObject {
    ...
    Q_PROPERTY(double getValue READ getValue WRITE setValue)
public:
    QtOAIDoubleResponse();
    QtOAIDoubleResponse(const QString &json);
    ~QtOAIDoubleResponse() override;
...
Q_DECLARE_METATYPE(QtOpenAPI::QtOAIDoubleResponse)

#endif // QtOAIDoubleResponse_H
