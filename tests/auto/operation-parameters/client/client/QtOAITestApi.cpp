...
void QtOAITestApi::cookieExplodeAnytypeWithDataImpl(const QJsonValue &anytypeParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        flags.setFlag(SerializationFlag::Object, anytypeParameter.type() == QJsonValue::Object);
        ...
        opts.suffix = getParamStyleSuffix(opts.style, u"anytypeParameter"_s, flags);
        opts.flags = flags;

        QString cookieString;
        cookieString = serializeJsonValue(anytypeParameter, opts);
...
void QtOAITestApi::cookieExplodeArrayWithDataImpl(const QList<qint32> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"arrayParameter"_s, flags);
        opts.flags = flags;

        QString cookieString;
        cookieString = serializeArrayValue(arrayParameter, opts);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
...
void QtOAITestApi::cookieExplodeIntWithDataImpl(const ::QtOpenAPI::OptionalParam<qint64> &intParameter, const ::QtOpenAPI::OptionalParam<QString> &queryParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"queryParameter"_s), flags);
        opts.flags = flags;
        ...
        if (queryParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(queryParameter.value())));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
    ...
    if (intParameter.hasValue())
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"intParameter"_s, flags);
        opts.flags = flags;

        QString cookieString;
        cookieString = opts.suffix + toStringValue(intParameter.value());
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
...
void QtOAITestApi::cookieExplodeObjectWithDataImpl(const QtOAITestObject &objectParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"objectParameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::cookieExplodeStringWithDataImpl(const QString &stringParameter, const QString &pathParam, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    m_networkFactory->setBaseUrl(serverUrl);
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"pathParam"_s), flags);
        opts.flags = flags;
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"stringParameter"_s, flags);
        opts.flags = flags;

        QString cookieString;
        cookieString = opts.suffix + toStringValue(stringParameter);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
...
void QtOAITestApi::cookieExplodeStringMapWithDataImpl(const QMap<QString, QString> &mapParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"mapParameter"_s, flags);
        opts.flags = flags;

        QString cookieString;
        cookieString = opts.suffix + serializeMapValue(mapParameter, opts);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
...
void QtOAITestApi::cookieNotExplodeAnytypeWithDataImpl(const ::QtOpenAPI::OptionalParam<QJsonValue> &anytypeParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (anytypeParameter.hasValue())
    {
        ...
        SerializationFlags flags;
        flags.setFlag(SerializationFlag::Object, anytypeParameter.value().type() == QJsonValue::Object);
        flags.setFlag(SerializationFlag::NeedPercentEncoding, false);
        ...
        QString cookieString;
        cookieString = serializeJsonValue(anytypeParameter.value(), opts);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
            cookieString = u"anytypeParameter="_s;
        input.m_headers.append(QHttpHeaders::WellKnownHeader::Cookie,
...
void QtOAITestApi::cookieNotExplodeArrayWithDataImpl(const ::QtOpenAPI::OptionalParam<QList<qint32>> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (arrayParameter.hasValue())
    {
        ...
        QString cookieString;
        cookieString = serializeArrayValue(arrayParameter.value(), opts);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
            cookieString = u"arrayParameter="_s;
        input.m_headers.append(QHttpHeaders::WellKnownHeader::Cookie,
...
void QtOAITestApi::cookieNotExplodeIntWithDataImpl(const QString &queryParameter, const ::QtOpenAPI::OptionalParam<qint64> &intParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
            ...
            fullPath.append(opts.prefix);
        {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(queryParameter)));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::cookieNotExplodeStringWithDataImpl(const QString &pathParam, const ::QtOpenAPI::OptionalParam<QString> &stringParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (stringParameter.hasValue())
    {
        ...
        QString cookieString;
        cookieString = opts.suffix + toStringValue(stringParameter.value());
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
            cookieString = u"stringParameter="_s;
        input.m_headers.append(QHttpHeaders::WellKnownHeader::Cookie,
...
void QtOAITestApi::cookieNotExplodeStringMapWithDataImpl(const ::QtOpenAPI::OptionalParam<QMap<QString, QString>> &mapParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (mapParameter.hasValue())
    {
        ...
        QString cookieString;
        cookieString = opts.suffix + serializeMapValue(mapParameter.value(), opts);
        // See https://spec.openapis.org/oas/v3.1.1.html#style-values column "undefined"
        if (cookieString.isEmpty())
            cookieString = u"mapParameter="_s;
        input.m_headers.append(QHttpHeaders::WellKnownHeader::Cookie,
...
void QtOAITestApi::deepObjectExplodeAnytypeWithDataImpl(const QJsonValue &anytypeParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        SerializationOptions opts;
        opts.style = "deepObject"_L1.isEmpty() ? "form"_L1 : "deepObject"_L1;
        opts.prefix = getParamStylePrefix(opts.style);
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"anytypeParameter"_s), flags);
        opts.flags = flags;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        {
            ...
            if (paramType != QJsonValue::Object) {
                if (opts.style == "deepObject"_L1) {
                    qWarning("Be aware that 'deepObject' style is only valid for parameters of "
                           ...
                           && (opts.style == "pipeDelimited"_L1
                               || opts.style == "spaceDelimited"_L1)) {
                    qWarning("Be aware that '%s' style is invalid for primitive parameters. "
                             ...
                             qPrintable(opts.style));
                }
            }
            paramString = serializeJsonValue(anytypeParameter, opts);
...
void QtOAITestApi::deepObjectExplodeModelMapWithDataImpl(const QMap<QString, QtOAITestObject> &mapParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"mapParameter"_s), flags);
        opts.flags = flags;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        {
            ...
            if (opts.style == "deepObject"_L1) {
                ...
                for (const auto &[key, value] : mapParameter.asKeyValueRange()) {
                    ...
                    paramString.append(opts.suffix + QUrl::toPercentEncoding(u"[%1]"_s.arg(key)) + opts.assignOperator + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(value)));
                    index++;
                }
            } else {
                paramString.append(serializeMapValue(mapParameter, opts));
            }
            fullPath.append(paramString);
            queryParamCounter++;
        }
...
void QtOAITestApi::deepObjectExplodeObjectWithDataImpl(const QtOAITestObject &objectParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"objectParameter"_s), flags);
        opts.flags = flags;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        {
...
void QtOAITestApi::formExplodeArrayWithDataImpl(const QList<qint32> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"arrayParameter"_s), flags);
        opts.flags = flags;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(serializeArrayValue(arrayParameter, opts));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeDifferentOptionsWithDataImpl(const qint32 &stringParameterB, const ::QtOpenAPI::OptionalParam<QtOAITestObject> &objectParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    }
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"stringParameterB"_s), flags);
        opts.flags = flags;
        paramString = opts.suffix;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(stringParameterB)));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeDoubleWithDataImpl(const ::QtOpenAPI::OptionalParam<double> &doubleParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"doubleParameter"_s), flags);
        opts.flags = flags;
        paramString = opts.suffix;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        if (doubleParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(doubleParameter.value())));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeFloatWithDataImpl(const ::QtOpenAPI::OptionalParam<float> &floatParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"floatParameter"_s), flags);
        opts.flags = flags;
        paramString = opts.suffix;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        if (floatParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(floatParameter.value())));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeIntWithDataImpl(const ::QtOpenAPI::OptionalParam<qint64> &intParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        if (intParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(intParameter.value())));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeStringWithDataImpl(const ::QtOpenAPI::OptionalParam<QString> &stringParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        if (stringParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(stringParameter.value())));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
...
void QtOAITestApi::formExplodeStringOptionsWithDataImpl(const QString &stringParameterB, const ::QtOpenAPI::OptionalParam<QString> &stringParameterA, const ::QtOpenAPI::OptionalParam<qint32> &stringParameterC, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"stringParameterA"_s), flags);
        opts.flags = flags;
        paramString = opts.suffix;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        if (stringParameterA.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(stringParameterA.value())));
            queryParamCounter++;
    ...
    }
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"stringParameterC"_s), flags);
        opts.flags = flags;
        paramString = opts.suffix;
        if ((fullPath.indexOf("?") != fullPath.size() - 1) && (queryParamCounter == 0))
            fullPath.append(opts.prefix);
        if (stringParameterC.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(opts.suffix + QUrl::toPercentEncoding(::QtOpenAPI::toStringValue(stringParameterC.value())));
            queryParamCounter++;
...
void QtOAITestApi::formNotExplodeAnytypeWithDataImpl(const ::QtOpenAPI::OptionalParam<QJsonValue> &anytypeParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        if (anytypeParameter.hasValue()) {
            ...
            paramString = serializeJsonValue(anytypeParameter.value(), opts);
            fullPath.append(paramString);
            queryParamCounter++;
        }
    }
...
void QtOAITestApi::formNotExplodeArrayWithDataImpl(const ::QtOpenAPI::OptionalParam<QList<qint32>> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    int queryParamCounter = 0;
    {
        ...
        if (arrayParameter.hasValue()) {
            if (queryParamCounter > 0)
                fullPath.append("&");
            fullPath.append(serializeArrayValue(arrayParameter.value(), opts));
            queryParamCounter++;
        }
    }
    // set m_testOperationPath for serialization tests
    ...
    int queryParamCounter = 0;
    {
        ...
        if (mapParameter.hasValue()) {
            ...
            if (opts.style == "deepObject"_L1) {
                ...
                paramString.append(serializeMapValue(mapParameter.value(), opts));
            }
            fullPath.append(paramString);
            queryParamCounter++;
        }
...
void QtOAITestApi::headerInvalidLabelNotExplodeStringWithDataImpl(const ::QtOpenAPI::OptionalParam<QString> &stringParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (stringParameter.hasValue())
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"String-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::headerSimpleExplodeAnytypeWithDataImpl(const QJsonValue &anyTypeParameter, const ::QtOpenAPI::OptionalParam<QString> &queryParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"Any-Type-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::headerSimpleExplodeArrayWithDataImpl(const QList<qint32> &arrayParameter, const ::QtOpenAPI::OptionalParam<QString> &queryParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"Array-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::headerSimpleExplodeMapWithDataImpl(const QMap<QString, QString> &mapParameter, const ::QtOpenAPI::OptionalParam<QString> &queryParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"Map-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::headerSimpleExplodeObjectWithDataImpl(const QtOAITestObject &objectParameter, const ::QtOpenAPI::OptionalParam<QString> &queryParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"Object-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::headerSimpleNotExplodeContentTypeWithDataImpl(const QString &contentType, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"Content-Type"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::labelExplodeAnytypeWithDataImpl(const QJsonValue &anytypeParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    m_networkFactory->setBaseUrl(serverUrl);
    {
        ...
        SerializationOptions opts;
        opts.style = "label"_L1.isEmpty() ? "simple"_L1 : "label"_L1;
        opts.prefix = getParamStylePrefix(opts.style);
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"anytypeParameter"_s), flags);
        opts.flags = flags;
        QString paramString = opts.prefix + serializeJsonValue(anytypeParameter, opts);
        // In case style=matrix and paramString is empty due to any reasons,
        // we serialize it like undefined value and delete '='.
        // Described here: https://spec.openapis.org/oas/v3.1.1.html#style-values
        if ((paramString == opts.prefix + opts.suffix) && QString("label") == "matrix"_L1)
            paramString.chop(1);
...
void QtOAITestApi::labelExplodeArrayWithDataImpl(const QList<qint32> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    m_networkFactory->setBaseUrl(serverUrl);
    {
        ...
        opts.flags = flags;
        QString paramString = opts.prefix + opts.suffix;
        paramString = opts.prefix + serializeArrayValue(arrayParameter, opts);
        // In case style=matrix and paramString is empty due to any reasons,
        // we serialize it like undefined value and delete '='.
        // Described here: https://spec.openapis.org/oas/v3.1.1.html#style-values
        if ((paramString == opts.prefix + opts.suffix) && QString("label") == "matrix"_L1)
...
void QtOAITestApi::labelExplodeObjectWithDataImpl(const QtOAITestObject &objectParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    m_networkFactory->setBaseUrl(serverUrl);
    {
        ...
        opts.flags = flags;
        QString paramString = opts.prefix + opts.suffix;
        paramString = opts.prefix + serializeJsonValue(QJsonValue(objectParameter.asJsonObject()), opts);
        // In case style=matrix and paramString is empty due to any reasons,
        // we serialize it like undefined value and delete '='.
        // Described here: https://spec.openapis.org/oas/v3.1.1.html#style-values
        if ((paramString == opts.prefix + opts.suffix) && QString("label") == "matrix"_L1)
...
void QtOAITestApi::labelStringMatrixArrayNotExplodeWithDataImpl(const QString &stringParameter, const QList<qint32> &arrayParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    }
    {
        ...
        SerializationOptions opts;
        opts.style = "matrix"_L1.isEmpty() ? "simple"_L1 : "matrix"_L1;
        opts.prefix = getParamStylePrefix(opts.style);
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"arrayParameter"_s), flags);
        ...
        // we serialize it like undefined value and delete '='.
        // Described here: https://spec.openapis.org/oas/v3.1.1.html#style-values
        if ((paramString == opts.prefix + opts.suffix) && QString("matrix") == "matrix"_L1)
            paramString.chop(1);
        fullPath.replace(arrayParameterPathParam, paramString);
    }
...
void QtOAITestApi::severalHeaderParametersOpWithDataImpl(const ::QtOpenAPI::OptionalParam<QString> &stringParameter, const ::QtOpenAPI::OptionalParam<qint32> &intParameter, const ::QtOpenAPI::OptionalParam<QtOAITestObject> &objectParameter, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    if (intParameter.hasValue())
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, u"int-Parameter"_s, flags);
        opts.flags = flags;
...
void QtOAITestApi::simpleExplodeStringsWithDataImpl(const QString &stringParameter1, const QString &stringParameter2, const QObject *context, QtPrivate::QSlotObjectBase *slot)
{
    ...
    m_networkFactory->setBaseUrl(serverUrl);
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"stringParameter1"_s), flags);
        opts.flags = flags;
        QString paramString = opts.prefix + opts.suffix;
    ...
    }
    {
        ...
        opts.delimiter = getParamStyleDelimiter(opts.style, flags);
        opts.assignOperator = getParamStyleAssignOperator(opts.style, flags);
        opts.suffix = getParamStyleSuffix(opts.style, QUrl::toPercentEncoding(u"stringParameter2"_s), flags);
        opts.flags = flags;
        QString paramString = opts.prefix + opts.suffix;
