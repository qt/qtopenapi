...
QString parameterToString(const QString &key, const QString &assignOperator, const QJsonValue &jval)
{
    ...
    switch(jval.type()) {
        case QJsonValue::String:
            paramString.append(key + assignOperator + jval.toString());
            break;
        case QJsonValue::Double:
            paramString.append(key + assignOperator + QVariant(jval.toDouble()).toString());
            break;
        case QJsonValue::Bool:
            paramString.append(key + assignOperator + QVariant(jval.toBool()).toString());
            break;
        case QJsonValue::Array:
            paramString.append(key + assignOperator + ::OpenAPI::toStringValue(jval.toArray().toVariantList(), assignOperator));
            break;
        case QJsonValue::Object:
            paramString.append(key + assignOperator + ::OpenAPI::toStringValue(jval.toObject().toVariantMap(), assignOperator));
            break;
...
QString optionParameterToString(const QString &key, const QString &assignOperator, const QJsonValue &jval)
{
    ...
    switch(jval.type()) {
        ...
        case QJsonValue::Null:
            paramString.append(key + assignOperator + QString("null"));
            break;
        case QJsonValue::Undefined:
            break;
    }
