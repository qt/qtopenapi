...
# Documentation for Client with &#39;QtOpenAPICommon&#39; option Test 1.0.0 Qt6 Client Cpp
...
#include "../client/QtOAIClient1TestApi.h"

int main(int argc, char *argv[]) {
    QCoreApplication a(argc, argv);
    QString stringParameter;
    QtOAIClient1TestApi apiInstance;
    ...
    */
    connect(&apiInstance, &QtOAIClient1TestApi::simpleExplodeStringFinished, [&](QString summary) {
               // handling the user logic
           });
    connect(&apiInstance, &QtOAIClient1TestApi::simpleExplodeStringErrorOccurred, [&](QNetworkReply::NetworkError errorType, const QString &errorStr) {
