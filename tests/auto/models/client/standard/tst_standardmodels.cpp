...
void StandardModelsTest::testCatJsonConversionMethods()
{
    ...
    QCOMPARE(cat.isHuntsValueSet(), isHuntsSet);
    QCOMPARE(cat.isHuntsValueValid(), isHuntsValid);
    QCOMPARE(cat.isAgeValueSet(), isAgeSet);
    QCOMPARE(cat.isAgeValueValid(), isAgeValid);
    ...
    QCOMPARE(fromJson.isHuntsValueSet(), isHuntsSet);
    QCOMPARE(fromJson.isHuntsValueValid(), isHuntsValid);
    QCOMPARE(fromJson.isAgeValueSet(), isAgeSet);
    QCOMPARE(fromJson.isAgeValueValid(), isAgeValid);
    ...
    QCOMPARE(fromObject.isHuntsValueSet(), isHuntsSet);
    QCOMPARE(fromObject.isHuntsValueValid(), isHuntsValid);
    QCOMPARE(fromObject.isAgeValueSet(), isAgeSet);
    QCOMPARE(fromObject.isAgeValueValid(), isAgeValid);
    ...
    QCOMPARE(fromJson.isHuntsValueSet(), defaultObject.isHuntsValueSet());
    QCOMPARE(fromJson.isHuntsValueValid(), defaultObject.isHuntsValueValid());
    QCOMPARE(fromJson.isAgeValueSet(), defaultObject.isAgeValueSet());
    QCOMPARE(fromJson.isAgeValueValid(), defaultObject.isAgeValueValid());
...
void StandardModelsTest::testDogJsonConversionMethods()
{
    ...
    QCOMPARE(dog.isBarkValueSet(), isBarkSet);
    QCOMPARE(dog.isBarkValueValid(), isBarkValid);
    QCOMPARE(dog.isBreedValueSet(), isBreedSet);
    QCOMPARE(dog.isBreedValueValid(), isBreedValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isBarkValueSet(), isBarkSet);
    QCOMPARE(fromJson.isBarkValueValid(), isBarkValid);
    QCOMPARE(fromJson.isBreedValueSet(), isBreedSet);
    QCOMPARE(fromJson.isBreedValueValid(), isBreedValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isBarkValueSet(), isBarkSet);
    QCOMPARE(fromObject.isBarkValueValid(), isBarkValid);
    QCOMPARE(fromObject.isBreedValueSet(), isBreedSet);
    QCOMPARE(fromObject.isBreedValueValid(), isBreedValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testBunnyJsonConversionMethods()
{
    ...
    QCOMPARE(bunny.isWeightValueSet(), isWeightSet);
    QCOMPARE(bunny.isWeightValueValid(), isWeightValid);
    QCOMPARE(bunny.isExportingCountriesValueSet(), isExportingCountriesSet);
    QCOMPARE(bunny.isExportingCountriesValueValid(), isExportingCountriesValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isWeightValueSet(), isWeightSet);
    QCOMPARE(fromJson.isWeightValueValid(), isWeightValid);
    QCOMPARE(fromJson.isExportingCountriesValueSet(), isExportingCountriesSet);
    QCOMPARE(fromJson.isExportingCountriesValueValid(), isExportingCountriesValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isWeightValueSet(), isWeightSet);
    QCOMPARE(fromObject.isWeightValueValid(), isWeightValid);
    QCOMPARE(fromObject.isExportingCountriesValueSet(), isExportingCountriesSet);
    QCOMPARE(fromObject.isExportingCountriesValueValid(), isExportingCountriesValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testDuckFamilyJsonConversionMethods()
{
    ...
    QCOMPARE(duckFamily.isCountryOfOriginValueSet(), isCountryOfOriginSet);
    QCOMPARE(duckFamily.isCountryOfOriginValueValid(), isCountryOfOriginValid);
    QCOMPARE(duckFamily.isCountValueSet(), isCountSet);
    QCOMPARE(duckFamily.isCountValueValid(), isCountValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isCountryOfOriginValueSet(), isCountryOfOriginSet);
    QCOMPARE(fromJson.isCountryOfOriginValueValid(), isCountryOfOriginValid);
    QCOMPARE(fromJson.isCountValueSet(), isCountSet);
    QCOMPARE(fromJson.isCountValueValid(), isCountValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isCountryOfOriginValueSet(), isCountryOfOriginSet);
    QCOMPARE(fromObject.isCountryOfOriginValueValid(), isCountryOfOriginValid);
    QCOMPARE(fromObject.isCountValueSet(), isCountSet);
    QCOMPARE(fromObject.isCountValueValid(), isCountValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testDuckJsonConversionMethods()
{
    ...
    QCOMPARE(duck.isBitesValueSet(), isBitesSet);
    QCOMPARE(duck.isBitesValueValid(), isBitesValid);
    QCOMPARE(duck.isFamilyValueSet(), isFamilySet);
    QCOMPARE(duck.isFamilyValueValid(), isFamilyValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isBitesValueSet(), isBitesSet);
    QCOMPARE(fromJson.isBitesValueValid(), isBitesValid);
    QCOMPARE(fromJson.isFamilyValueSet(), isFamilySet);
    QCOMPARE(fromJson.isFamilyValueValid(), isFamilyValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isBitesValueSet(), isBitesSet);
    QCOMPARE(fromObject.isBitesValueValid(), isBitesValid);
    QCOMPARE(fromObject.isFamilyValueSet(), isFamilySet);
    QCOMPARE(fromObject.isFamilyValueValid(), isFamilyValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testEnteJsonConversionMethods()
{
    ...
    QCOMPARE(ente.isBitesValueSet(), isBitesSet);
    QCOMPARE(ente.isBitesValueValid(), isBitesValid);
    QCOMPARE(ente.isFamilyValueSet(), isFamilySet);
    QCOMPARE(ente.isFamilyValueValid(), isFamilyValid);
...
void StandardModelsTest::testPostAccountRequestOtherAccDataInnerJsonConversionMethods()
{
    ...
    QCOMPARE(inner.isPayloadValueSet(), isPayloadSet);
    QCOMPARE(inner.isPayloadValueValid(), isPayloadValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isPayloadValueSet(), isPayloadSet);
    QCOMPARE(fromJson.isPayloadValueValid(), isPayloadValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isPayloadValueSet(), isPayloadSet);
    QCOMPARE(fromObject.isPayloadValueValid(), isPayloadValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testPostAccountRequestJsonConversionMethods()
{
    ...
    QCOMPARE(request.isCardNumberValueSet(), isCardNumberSet);
    QCOMPARE(request.isCardNumberValueValid(), isCardNumberValid);
    QCOMPARE(request.isCardDataValueSet(), isCardDataSet);
    QCOMPARE(request.isCardDataValueValid(), isCardDataValid);
    QCOMPARE(request.isCardAvailabilityValueSet(), isCardAvailabilitySet);
    QCOMPARE(request.isCardAvailabilityValueValid(), isCardAvailabilityValid);
    QCOMPARE(request.isCardSecretCodeValueSet(), isCardSecretCodeSet);
    QCOMPARE(request.isCardSecretCodeValueValid(), isCardSecretCodeValid);
    QCOMPARE(request.isOtherAccDataValueSet(), isOtherAccDataSet);
    QCOMPARE(request.isOtherAccDataValueValid(), isOtherAccDataValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isCardNumberValueSet(), isCardNumberSet);
    QCOMPARE(fromJson.isCardNumberValueValid(), isCardNumberValid);
    QCOMPARE(fromJson.isCardDataValueSet(), isCardDataSet);
    QCOMPARE(fromJson.isCardDataValueValid(), isCardDataValid);
    QCOMPARE(fromJson.isCardAvailabilityValueSet(), isCardAvailabilitySet);
    QCOMPARE(fromJson.isCardAvailabilityValueValid(), isCardAvailabilityValid);
    QCOMPARE(fromJson.isCardSecretCodeValueSet(), isCardSecretCodeSet);
    QCOMPARE(fromJson.isCardSecretCodeValueValid(), isCardSecretCodeValid);
    QCOMPARE(fromJson.isOtherAccDataValueSet(), isOtherAccDataSet);
    QCOMPARE(fromJson.isOtherAccDataValueValid(), isOtherAccDataValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isCardNumberValueSet(), isCardNumberSet);
    QCOMPARE(fromObject.isCardNumberValueValid(), isCardNumberValid);
    QCOMPARE(fromObject.isCardDataValueSet(), isCardDataSet);
    QCOMPARE(fromObject.isCardDataValueValid(), isCardDataValid);
    QCOMPARE(fromObject.isCardAvailabilityValueSet(), isCardAvailabilitySet);
    QCOMPARE(fromObject.isCardAvailabilityValueValid(), isCardAvailabilityValid);
    QCOMPARE(fromObject.isCardSecretCodeValueSet(), isCardSecretCodeSet);
    QCOMPARE(fromObject.isCardSecretCodeValueValid(), isCardSecretCodeValid);
    QCOMPARE(fromObject.isOtherAccDataValueSet(), isOtherAccDataSet);
    QCOMPARE(fromObject.isOtherAccDataValueValid(), isOtherAccDataValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testAnimalJsonConversionMethods()
{
    ...
    QCOMPARE(animal.isNestedMapValueSet(), isNestedMapSet);
    QCOMPARE(animal.isNestedMapValueValid(), isNestedMapValid);
    ...
    QCOMPARE(fromJson.asJson(), expectedJson);
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.isNestedMapValueSet(), isNestedMapSet);
    QCOMPARE(fromJson.isNestedMapValueValid(), isNestedMapValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJson(), expectedJson);
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.isNestedMapValueSet(), isNestedMapSet);
    QCOMPARE(fromObject.isNestedMapValueValid(), isNestedMapValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testTierJsonConversionMethods()
{
    ...
    QCOMPARE(tier.isNestedMapValueSet(), isNestedMapSet);
    QCOMPARE(tier.isNestedMapValueValid(), isNestedMapValid);
...
void StandardModelsTest::testTiereJsonConversionMethods()
{
    ...
    QCOMPARE(tiere.isNameValueSet(), isNameSet);
    QCOMPARE(tiere.isNameValueValid(), isNameValid);
    QCOMPARE(tiere.isDeepNestedMapValueSet(), isDeepNestedMapSet);
    QCOMPARE(tiere.isDeepNestedMapValueValid(), isDeepNestedMapValid);
    QCOMPARE(tiere.isSpeciesListValueSet(), isSpeciesListSet);
    QCOMPARE(tiere.isSpeciesListValueValid(), isSpeciesListValid);
    QCOMPARE(tiere.isMetadataValueSet(), isMetadataSet);
    QCOMPARE(tiere.isMetadataValueValid(), isMetadataValid);
    ...
    QCOMPARE(fromJson.asJsonValue(), testValue);
    QCOMPARE(fromJson.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromJson.isNameValueSet(), isNameSet);
    QCOMPARE(fromJson.isNameValueValid(), isNameValid);
    QCOMPARE(fromJson.isDeepNestedMapValueSet(), isDeepNestedMapSet);
    QCOMPARE(fromJson.isDeepNestedMapValueValid(), isDeepNestedMapValid);
    QCOMPARE(fromJson.isSpeciesListValueSet(), isSpeciesListSet);
    QCOMPARE(fromJson.isSpeciesListValueValid(), isSpeciesListValid);
    QCOMPARE(fromJson.isMetadataValueSet(), isMetadataSet);
    QCOMPARE(fromJson.isMetadataValueValid(), isMetadataValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.asJsonValue(), testValue);
    QCOMPARE(fromObject.asJsonValue().toObject(), testValue.toObject());
    QCOMPARE(fromObject.isNameValueSet(), isNameSet);
    QCOMPARE(fromObject.isNameValueValid(), isNameValid);
    QCOMPARE(fromObject.isDeepNestedMapValueSet(), isDeepNestedMapSet);
    QCOMPARE(fromObject.isDeepNestedMapValueValid(), isDeepNestedMapValid);
    QCOMPARE(fromObject.isSpeciesListValueSet(), isSpeciesListSet);
    QCOMPARE(fromObject.isSpeciesListValueValid(), isSpeciesListValid);
    QCOMPARE(fromObject.isMetadataValueSet(), isMetadataSet);
    QCOMPARE(fromObject.isMetadataValueValid(), isMetadataValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testPflanzeJsonConversionMethods()
{
    ...
    QCOMPARE(pflanze.isNameValueSet(), isNameSet);
    QCOMPARE(pflanze.isNameValueValid(), isNameValid);
    QCOMPARE(pflanze.isSchoolDataValueSet(), isSchoolDataSet);
    QCOMPARE(pflanze.isSchoolDataValueValid(), isSchoolDataValid);
    ...
    QCOMPARE(fromJson.isNameValueSet(), isNameSet);
    QCOMPARE(fromJson.isNameValueValid(), isNameValid);
    QCOMPARE(fromJson.isSchoolDataValueSet(), isSchoolDataSet);
    QCOMPARE(fromJson.isSchoolDataValueValid(), isSchoolDataValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.isNameValueSet(), isNameSet);
    QCOMPARE(fromObject.isNameValueValid(), isNameValid);
    QCOMPARE(fromObject.isSchoolDataValueSet(), isSchoolDataSet);
    QCOMPARE(fromObject.isSchoolDataValueValid(), isSchoolDataValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testFaunaJsonConversionMethods()
{
    ...
    QCOMPARE(fauna.isNameValueSet(), isNameSet);
    QCOMPARE(fauna.isNameValueValid(), isNameValid);
    QCOMPARE(fauna.isDeepMapWithListsValueSet(), isDeepMapWithListsSet);
    QCOMPARE(fauna.isDeepMapWithListsValueValid(), isDeepMapWithListsValid);
    QCOMPARE(fauna.isHabitatDataValueSet(), isHabitatDataSet);
    QCOMPARE(fauna.isHabitatDataValueValid(), isHabitatDataValid);
    QCOMPARE(fauna.isComplexNestingValueSet(), isComplexNestingSet);
    QCOMPARE(fauna.isComplexNestingValueValid(), isComplexNestingValid);
    ...
    QCOMPARE(fromJson.isNameValueSet(), isNameSet);
    QCOMPARE(fromJson.isNameValueValid(), isNameValid);
    QCOMPARE(fromJson.isDeepMapWithListsValueSet(), isDeepMapWithListsSet);
    QCOMPARE(fromJson.isDeepMapWithListsValueValid(), isDeepMapWithListsValid);
    QCOMPARE(fromJson.isHabitatDataValueSet(), isHabitatDataSet);
    QCOMPARE(fromJson.isHabitatDataValueValid(), isHabitatDataValid);
    QCOMPARE(fromJson.isComplexNestingValueSet(), isComplexNestingSet);
    QCOMPARE(fromJson.isComplexNestingValueValid(), isComplexNestingValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.isNameValueSet(), isNameSet);
    QCOMPARE(fromObject.isNameValueValid(), isNameValid);
    QCOMPARE(fromObject.isDeepMapWithListsValueSet(), isDeepMapWithListsSet);
    QCOMPARE(fromObject.isDeepMapWithListsValueValid(), isDeepMapWithListsValid);
    QCOMPARE(fromObject.isHabitatDataValueSet(), isHabitatDataSet);
    QCOMPARE(fromObject.isHabitatDataValueValid(), isHabitatDataValid);
    QCOMPARE(fromObject.isComplexNestingValueSet(), isComplexNestingSet);
    QCOMPARE(fromObject.isComplexNestingValueValid(), isComplexNestingValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
...
void StandardModelsTest::testFloraJsonConversionMethods()
{
    ...
    QCOMPARE(flora.isNameValueSet(), isNameSet);
    QCOMPARE(flora.isNameValueValid(), isNameValid);
    QCOMPARE(flora.isPlantDataValueSet(), isPlantDataSet);
    QCOMPARE(flora.isPlantDataValueValid(), isPlantDataValid);
    ...
    QCOMPARE(fromJson.isNameValueSet(), isNameSet);
    QCOMPARE(fromJson.isNameValueValid(), isNameValid);
    QCOMPARE(fromJson.isPlantDataValueSet(), isPlantDataSet);
    QCOMPARE(fromJson.isPlantDataValueValid(), isPlantDataValid);
    QCOMPARE(fromJson.isSet(), modelIsSet);
    QCOMPARE(fromJson.isValid(), modelIsValid);
    ...
    QCOMPARE(fromObject.isNameValueSet(), isNameSet);
    QCOMPARE(fromObject.isNameValueValid(), isNameValid);
    QCOMPARE(fromObject.isPlantDataValueSet(), isPlantDataSet);
    QCOMPARE(fromObject.isPlantDataValueValid(), isPlantDataValid);
    QCOMPARE(fromObject.isSet(), modelIsSet);
    QCOMPARE(fromObject.isValid(), modelIsValid);
